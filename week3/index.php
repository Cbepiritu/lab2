    ...
    <div id="viewport" class="l-viewport">
      <div class="l-wrapper">
        <header class="header">
          ...
          <button class="header--cta cta">Royal</button>
          ...
          <li class="l-section section section--is-active">
            <div class="intro">
              ...
              <div class="intro--options">
                ...
                <a href="#0">
                  <h3>Facts.</h3>
                  <p>I got this Website template from the internet.</p>
                </a>
              </div>
            </div>
          </li>
                ...
                <ul class="slider">
                  <li class="slider--item slider--item-left">
                    <a href="#0">
                      <div class="slider--item-image">
                        <img src="assets/img/R1M.png" alt="Victory">
                      </div>
                      <p class="slider--item-title">Hobbies</p>
                      <p class="slider--item-description">I like Playing video game, working on engines, and Programming.</p>
                    </a>
                  </li>
                  ...
                  <li class="slider--item slider--item-right">
                    <a href="#0">
                      ...
                      <p class="slider--item-title">Career</p>
                      <p class="slider--item-description">Still building it....... Im trying, ok?!.</p>
                    </a>
                  </li>
                </ul>
          ...
          <li class="l-section section">
            <div class="about">
              <div class="about--banner">
                <h2>believe in<br>passionate<br>people</h2>
                <a href="#0">Career
                  <span>
                    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 150 118" style="enable-background:new 0 0 150 118;" xml:space="preserve">
                    <g transform="translate(0.000000,118.000000) scale(0.100000,-0.100000)">
